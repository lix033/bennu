fetch('shipment3.json')
  ...
  .then(data => {
    ...
    //   const eventCountry = `${event.eventPosition.status}: ${event.eventPosition.comments}`;
    ...
    //   else if (eventDescription === 'PICK UP DELAYED'){
    //     listItem.classList.add('expetion')
    //   }
